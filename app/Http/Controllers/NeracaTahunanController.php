...
array_push($idlimbah,$request->namalimbah);
        ...
        //     $periodOut[$data->created_at]=$data->pack; 
        // }  

        // $column=array('No.','Bulan')+$convertedPeriod;



        // $periodIn=array('jumlah_awal'=>'21')+$periodIn;
        // $periodIn['jumlah_akhir']='20';
        // $periodOut=array('jumlah_awal'=>'21')+$periodOut;
        // $periodOut['jumlah_akhir']='20';



        // $dataRow['in']=$periodIn;
        // $dataRow['out']=$periodOut;

        // foreach($periodIn as $data){
        //     $dataObj[]=(object)array(
        //         'date'=>$date
        //     )
        //     $periodIn['date']=$data[];
        //     $periodIn['month']='januari'; 
        // }  
