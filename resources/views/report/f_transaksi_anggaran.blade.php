    ...
    <div class="card-header">
        ...
        <div class="card-body">
            ...
            <div class="form-group nonpihakketiga">
                ...
                <select name="transaksi_tipelimbah" id="transaksi_tipelimbah"
                    class="formproses form-control select2bs4" style="width: 100%;">
            ...
            {{-- <div class="row">
                <div class="col-md-4"> --}}
                    <div class="form-group">
                        ...
                        <div class="input-group input-group mb-3">
                            <input type="text" name="jmlhlimbah" id="jmlhlimbah"
                ...
                <div class="col-md-4"> --}}
                    <div class="form-group">
                        ...
                        <input type="text" id="dataharga" name="dataharga"
                            class="numberinput formproses form-control " autocomplete="off">
                    </div>
                {{-- </div>
                <div class="col-md-4"> --}}
